...
import {
    ...
    ReadOutlined, SettingOutlined, EditOutlined, DeleteOutlined, AppstoreOutlined, FileSyncOutlined
}
                        ...
                        {sem.map((e) =>
                            <Tabs.TabPane {...e}>
                                ...
                                <Table dataSource={dataCoursesSem} bordered>
                                    <Column width={1} title='#' align='center' dataIndex='index' />
                                    <Column width={1.75} title={<Tooltip title='Mã môn học'><span>Mã</span></Tooltip>} align='center' render={e=>
                                        <div>{e.code}</div>
                                    } />
                                    <Column width={5} ellipsis title={<Tooltip title='Tên môn học'><span>Tên môn học</span></Tooltip>} align='center' render={e=>
                                        <div>{e.name}</div>
                                    } />
                                    <Column width={1.5} title={<Tooltip title='Số Tín Chỉ'><span>T.Chỉ</span></Tooltip>} align='center' />
                                </Table>
